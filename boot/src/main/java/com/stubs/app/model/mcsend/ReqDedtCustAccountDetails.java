...
public class ReqDedtCustAccountDetails {
	...
	@Valid
	private ReqProxyDirectory proxyDirectory = null;

	public ReqDedtCustAccountDetails accountType(String accountType) {
	 ...
	 */
	public ReqProxyDirectory getProxyDirectory() {
	 ...
	 */
	public void setProxyDirectory(ReqProxyDirectory proxyDirectory) {
		this.proxyDirectory = proxyDirectory;
	}

	public ReqDedtCustAccountDetails accountReference(String accountReference) {
	...
	public boolean equals(java.lang.Object o) {
		...
		ReqDedtCustAccountDetails reqDedtCustAccountDetails = (ReqDedtCustAccountDetails) o;
